...
# Initializing the wide option
st.set_page_config(layout="wide")

st.title('Sales Streamlit Dashboard')
st.markdown('Prototype v0.1_')
...
with st.sidebar:
    ...
    # Condition if the file is not uploaded
...
top_left_column_1, top_left_column_2, top_left_column_3, top_left_column_4, top_right_column = st.columns((1, 1, 1, 1, 4))
bottom_left_column, bottom_right_column = st.columns(2)

with top_left_column_1:
    plot_metric(
